...
export default function SideBar() {
  ...
  return (
    <>
      {isMobile ? (
        <Sheet>
          <SheetTrigger className="text-white fixed top-4 left-4 p-2 z-50">
          ...
          <SheetContent
            className="bg-black text-white w-[100px] sm:w-[120px] border border-[#333639] text-center"
            side="left"
          >
            <div className="flex flex-col items-center h-full py-4">
              ...
              <p className="text-sm sm:text-base">CloudCast</p>
              <div className="w-full h-[1px] bg-[#333639] my-2" />
              ...
              <div className="absolute bottom-0 py-4">
                <img
                  ...
                  src="https://api.dicebear.com/9.x/avataaars/svg?seed=Mustafa"
                  alt="Profile"
                />
              </div>
            </div>
        ...
        <div className="w-[80px] sm:w-[100px] h-full lg:h-[870px] lg:mt-4 relative text-white border border-[#333639] ml-0 md:ml-4 py-4 text-center rounded-2xl flex flex-col items-center">
          <div className="mt-2 py-2">
            <svg
              width={32}
              xmlns="http://www.w3.org/2000/svg"
          ...
          <p className="text-sm sm:text-base">CloudCast</p>
          <div className="w-full h-[1px] bg-[#333639] my-2 s " />
          <div className="flex-1" />
